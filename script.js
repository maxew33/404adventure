const story = [
    ...
    {
        "id": 14,
        "text": ["Quand on aime, on ne compte pas!","Enzo continue à boire son chat tout en caressant son café.", "Vous buvez votre café tranquillement en devisant avec votre ami de l'épisode de l'agence tout risque d'hier soir.", "Votre café avalé, vous réfléchissez à la suite des opérations.", "Qu'allez-vous faire ?", "1 : redescendre les 5 étages (il n'y a toujours pas d'ascenseur).", "2 : redescendre les 5 étages (et oui, il faudra bien le faire)." ],
        "path": [12, 12]
    },
    {
        "id": 15,
...
const writeText = (text, $section, answerInput) => {
    ...
    text.forEach((char, idx) => {
        setTimeout(() => {
            ...
            answerInput && ((prevId !== 17 && idx === text.length - 1) && (appendInput($container), formerTextLength = 0))
        }, idx * 10)
    })
